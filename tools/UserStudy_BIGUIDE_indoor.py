...
cfg = Config.fromfile("/home/i3t/lin/mmyolo/configs/custom_dataset/yolov5_s-v61_syncbn_fast_1xb1-30e_indoor.py")
init_default_scope(cfg.get('default_scope', 'mmyolo'))
model = init_detector("/home/i3t/lin/mmyolo/configs/custom_dataset/yolov5_s-v61_syncbn_fast_1xb1-30e_indoor.py", "/home/i3t/lin/mmyolo/work_dirs/yolov5_s-v61_syncbn_fast_1xb1-30e_indoor/best_coco_bbox_mAP_epoch_8.pth", device='cuda:0')
...
all_im_pca = pk.load(open("/home/i3t/lin/mmyolo/im_pca_indoor_lessrep.pkl",'rb'))
all_im_normlized_centers = np.load('/home/i3t/lin/mmyolo/im_normlized_centers_indoor_lessrep.npy')
all_im_x_min = np.load('/home/i3t/lin/mmyolo/im_min_max_indoor_lessrep.npy')[0]
all_im_x_max = np.load('/home/i3t/lin/mmyolo/im_min_max_indoor_lessrep.npy')[1]
all_im_rep = np.load('/home/i3t/lin/mmyolo/im_rep_indoor_lessrep.npy')
all_in_pca = pk.load(open("/home/i3t/lin/mmyolo/in_pca_indoor_lessrep.pkl",'rb'))
all_in_normlized_centers = np.load('/home/i3t/lin/mmyolo/in_normlized_centers_indoor_lessrep.npy')
all_in_x_min = np.load('/home/i3t/lin/mmyolo/in_min_max_indoor_lessrep.npy')[0]
all_in_x_max = np.load('/home/i3t/lin/mmyolo/in_min_max_indoor_lessrep.npy')[1]
all_in_rep = np.load('/home/i3t/lin/mmyolo/in_rep_indoor_lessrep.npy')
...
def guidance(d:ImgPathData):
    ...
    if all_im_accept and all_in_accept:
        ...
        print("!!!!!!!!!!!!!!!!!!!!!!!!!after update cluster time lag:"+str(time()-tc))
        with open('/home/i3t/lin/mmyolo/tools/record_latency.txt','a') as f:
            f.write('after update cluster time lag:'+str(time()-tc)+'\n')
    ...
    with open('/home/i3t/lin/mmyolo/tools/record_latency.txt','a') as f:
            f.write('Full Time for biguide guidance:'+str(time()-tg)+'\n')
    return jsonData
