...
if __name__ == '__main__':
  ...
  # get file list
  lines=open('/home/i3t/lin/mmyolo/data/cleanlemur/VOC2007/ImageSets/Main/train_new4class_s.txt').readlines()
  ...
  for line in lines:
    image_path='data/cleanlemur_coco/images/'+line.strip()+'.jpg'
    t1=time.time()
