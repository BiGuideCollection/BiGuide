...
all_im_pca = pk.load(open("/path to/mmyolo/im_pca_lemur_lessrep.pkl",'rb'))
all_im_normlized_centers = np.load('/path to/mmyolo/im_normlized_centers_lemur_lessrep.npy')
all_im_x_min = np.load('/path to/mmyolo/im_min_max_lemur_lessrep.npy')[0]
all_im_x_max = np.load('/path to/mmyolo/im_min_max_lemur_lessrep.npy')[1]
all_im_rep = np.load('/path to/mmyolo/im_rep_lemur_lessrep.npy')
all_in_pca = pk.load(open("/path to/mmyolo/in_pca_lemur_lessrep.pkl",'rb'))
all_in_normlized_centers = np.load('/path to/mmyolo/in_normlized_centers_lemur_lessrep.npy')
all_in_x_min = np.load('/path to/mmyolo/in_min_max_lemur_lessrep.npy')[0]
all_in_x_max = np.load('/path to/mmyolo/in_min_max_lemur_lessrep.npy')[1]
all_in_rep = np.load('/path to/mmyolo/in_rep_lemur_lessrep.npy')
...
def guidance(d:ImgPathData):
    ...
    if all_im_accept and all_in_accept:
        ...
        if round_cnt==round_num:       
            ...
            training_t_set=open("/path to/mmyolo/data/"+dataset_name+"/ImageSets/Main/"+training_t_set_name+".txt","w")
