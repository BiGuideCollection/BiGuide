...
data_root = './data/user_study_lemur_all_coco/'  # absolute path to the dataset directory
...
anchors = [  # the anchor has been updated according to the characteristics of dataset. The generation of anchor will be explained in the following section.
    [(61, 74), (121, 69), (114, 147)],  # P3/8
    [(206, 227), (187, 366), (335, 327)],  # P4/16
    [(456, 356), (398, 550), (540, 424)]  # P5/32
]

class_name = ('blue-eyed-black-lemur','red-ruffed-lemur','ring-tailed-lemur',)  # according to the label information of class_with_id.txt, set the class_name
