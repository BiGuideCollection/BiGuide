...
work_dir = './work_dirs/indoor_coverage_lin_5'
...
train_dataloader = dict(  
    ...
    dataset=dict(
        ...
        dataset=dict(
            ...
            data_root=data_root,
            metainfo=metainfo,
            ann_file='annotations/train_coverage_indoor_lin_5.json',
...
test_dataloader = dict(
    dataset=dict(
        metainfo=metainfo,
        data_root=data_root,
        ann_file='annotations/test_precollected_indoor.json',#test_indoor9_lin.json',
        data_prefix=dict(img='images/')))

val_evaluator = dict(ann_file=data_root + 'annotations/test_precollected_indoor.json')
test_evaluator = dict(ann_file=data_root + 'annotations/test_precollected_indoor.json')#test_indoor9_lin.json')
